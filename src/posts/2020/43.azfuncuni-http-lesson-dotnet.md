...
description: "An Azure Functions University lesson teaching how to use the HTTP trigger in Azure Functions with .NET Core 3.1, including GET and POST requests and custom routes."
date: 2020-10-28
---
