...
description: "An Azure Functions University lesson on using Blob triggers and input and output bindings in Azure Functions with .NET Core 3.1, plus the Azure Storage Explorer."
date: 2020-11-11
---
