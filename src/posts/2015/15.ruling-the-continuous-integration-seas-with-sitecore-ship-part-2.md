...
description: "Automating Sitecore package deployment with Sitecore.Ship, using Postman, cURL and PowerShell to upload and install packages in continuous integration."
date: 2015-10-31
---
