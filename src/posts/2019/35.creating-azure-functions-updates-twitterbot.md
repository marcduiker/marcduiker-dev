...
description: "How to build a Twitterbot with Azure Durable Functions that tracks new Azure Functions releases via the GitHub API and posts updates using Table Storage and Tweetinvi."
date: 2019-03-03
---
