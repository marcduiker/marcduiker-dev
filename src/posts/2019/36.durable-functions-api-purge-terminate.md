...
description: "Part 3 of the Durable Functions API series explains how to purge orchestration instance history from table storage and terminate running Azure orchestrations."
date: 2019-08-12
---
